...
func (_Contract *ContractCaller) Decimals(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "_decimals")
...
// MName is a free data retrieval call binding the contract method 0xd28d8852.
//
// Solidity: function _name() view returns(string)
func (_Contract *ContractCaller) MName(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "_name")
...
//
// Solidity: function _name() view returns(string)
func (_Contract *ContractSession) MName() (string, error) {
	return _Contract.Contract.MName(&_Contract.CallOpts)
}

// MName is a free data retrieval call binding the contract method 0xd28d8852.
//
// Solidity: function _name() view returns(string)
func (_Contract *ContractCallerSession) MName() (string, error) {
	return _Contract.Contract.MName(&_Contract.CallOpts)
}

// MSymbol is a free data retrieval call binding the contract method 0xb09f1266.
//
// Solidity: function _symbol() view returns(string)
func (_Contract *ContractCaller) MSymbol(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "_symbol")
...
//
// Solidity: function _symbol() view returns(string)
func (_Contract *ContractSession) MSymbol() (string, error) {
	return _Contract.Contract.MSymbol(&_Contract.CallOpts)
}

// MSymbol is a free data retrieval call binding the contract method 0xb09f1266.
//
// Solidity: function _symbol() view returns(string)
func (_Contract *ContractCallerSession) MSymbol() (string, error) {
	return _Contract.Contract.MSymbol(&_Contract.CallOpts)
}
...
// MDecimals is a free data retrieval call binding the contract method 0x313ce567.
//
// Solidity: function decimals() view returns(uint8)
func (_Contract *ContractCaller) MDecimals(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
...
//
// Solidity: function decimals() view returns(uint8)
func (_Contract *ContractSession) MDecimals() (uint8, error) {
	return _Contract.Contract.MDecimals(&_Contract.CallOpts)
}

// MDecimals is a free data retrieval call binding the contract method 0x313ce567.
//
// Solidity: function decimals() view returns(uint8)
func (_Contract *ContractCallerSession) MDecimals() (uint8, error) {
	return _Contract.Contract.MDecimals(&_Contract.CallOpts)
}
